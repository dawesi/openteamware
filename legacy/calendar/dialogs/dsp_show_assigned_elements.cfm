...
<cfoutput query="q_select_meeting_members">
	...
	<tr>
		...
		<td>
			<a href="javascript:removeAssignedElement('#jsstringformat(url.entrykey)#', '#q_select_meeting_members.type#', '#jsstringformat(q_select_meeting_members.parameter)#');"><span class="glyphicon glyphicon-trash"></span></a>
