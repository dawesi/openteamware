...
<cfmail from="#request.appsettings.properties.NotifyEmail#" to="#request.appsettings.properties.NotifyEmail#" subject="start">
a_int_dt_start_display: #a_int_dt_start_display#

a_int_dt_end_display: #a_int_dt_end_display#

a_dt_start: #a_dt_start#
</cfmail>
</cfif>--->
...
<!---<cfmail from="#request.appsettings.properties.NotifyEmail#" to="#request.appsettings.properties.NotifyEmail#" subject="cal" type="html">
	<cfdump var="#stReturn#" label="stReturn">
	<cfdump var="#q_select_events#" label="q_select_events">
</cfmail>--->
...
<body onLoad="parent.SetOtherEventsVisible(<cfoutput>#a_str_bol_show_iframe#</cfoutput>);" leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0" style="padding:4px;">
