...
<div class="divleftnavigation_center">
	...
	<div class="divleftnavpanelheader"><cfoutput>#GetLangVal('cm_wd_global')#</cfoutput></div>
			...
			<li><a href="index.cfm?action=ShowMailbox&Mailbox=INBOX"><cfoutput>#GetLangVal('cm_wd_inbox')#</cfoutput></a></li>
			<li><a href="index.cfm?action=folders"><cfoutput>#GetLangVal('mail_wd_folders')#</cfoutput></a></li>
			...
			<li><a href="index.cfm?action=filter"><cfoutput>#GetLangVal('email_wd_filter')#</cfoutput></a></li>
			<li><a href="index.cfm?action=showsearch"><cfoutput>#GetLangVal('cm_wd_search')#</cfoutput></a></li>
			<li><a href="/addressbook/"><cfoutput>#GetLangVal('cm_wd_address_book')#</cfoutput></a></li>			
			<li><a href="/settings/index.cfm?action=emailaccounts"><cfoutput>#GetLangVal('email_ph_pop3_collector')#</cfoutput></a></li>
	...
	<div class="divleftnavpanelheader"><cfoutput>#GetLangVal('cm_wd_extras')#</cfoutput></div>
			...
			<ul class="divleftpanelactions">
			<li><a href="index.cfm?action=autoanswer"><cfoutput>#GetLangVal('mail_ph_autoanswer')#</cfoutput></a></li>			
			<li><a href="index.cfm?action=alerts"><cfoutput>#GetLangVal('email_wd_alerts')#</cfoutput></a></li>
			<li><a href="/mobile/"><cfoutput>#GetLangVal('email_ph_mobile_access')#</cfoutput></a></li>
			<li><a href="index.cfm?action=extras"><cfoutput>#GetLangVal('email_ph_more_Extras')#</cfoutput></a></li>
			</ul>
	</div>	
