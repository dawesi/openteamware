...
<cfsavecontent variable="a_str_buttons">
	...
	<input onClick="call_edit_contact('<cfoutput>#jsstringformat(url.entrykey)#</cfoutput>', 'activities');" type="button" value="<cfoutput>#htmleditformat(MakeFirstCharUCase(GetLangVal('cm_wd_edit')))#</cfoutput>" class="btn btn-default" />
</cfsavecontent>
