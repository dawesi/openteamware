...
<tr>
	<td><a href="index.cfm" class="TopHeaderLink">&nbsp;<cfoutput>#GetLangVal("adrb_ph_show_all_contacts")#</cfoutput></a>&nbsp;</td>
	<td class="tdtopheaderdivider">|</td>
	<td>&nbsp;<a href="index.cfm?Action=createnewcontact" class="TopHeaderLink"><b><cfoutput>#GetLangval("adrb_ph_new_contact")#</cfoutput></b></a></td>

	<td class="tdtopheaderdivider">|</td>

	<td>
		<a href="index.cfm?action=remoteedit" class="TopHeaderLink"><cfoutput>#GetLangVal('adrb_wd_remote_edit')#</cfoutput></a>
	</td>
	
	<td class="tdtopheaderdivider">|</td>

	<td><a href="index.cfm?action=Mailinglists" class="TopHeaderLink"><cfoutput>#GetLangVal("adrb_wd_mailinglists")#</cfoutput></a></td>
