...
<cfoutput >
	<input type="button" value="#GetLangVal('adm_ph_add_new_top_level_criteria')#" onclick="GotoLocHref('index.cfm?action=criteria&subaction=AddCriteria#WriteUrlTags()#');" class="btn btn-primary" />
</cfoutput>
</cfsavecontent>
