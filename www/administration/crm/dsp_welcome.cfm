	...
	<tr>
		...
		<td>
			<cfif Len(a_struct_crmsales_bindings.ADDITIONALDATA_TABLEKEY) IS 0>
				<a href="index.cfm?action=crm&subaction=enablecrm_database<cfoutput>#WriteURLTags()#</cfoutput>"><cfoutput>#GetLangVal('adm_ph_crm_enable_assign_database')#</cfoutput></a>
	
			<cfelse>
				<cfoutput>#GetLangVal('adm_ph_crm_database_is_assigned')#</cfoutput>
				<br /><br />
				<a href="index.cfm?action=crm&subaction=database_properties<cfoutput>#WriteURLTags()#</cfoutput>"><cfoutput>#GetLangVal('adm_ph_edit_database_properties')#</cfoutput></b></a>  
				<br /><br />
				<a href="index.cfm?action=crm&subaction=reorganize<cfoutput>#WriteURLTags()#</cfoutput>">Reorganize and Check</a>  
			</cfif>
		</td>
	</tr>
	<tr>
