...
<table class="table table-hover">
  ...
  <tr>
	...
	&nbsp;&nbsp;
	<a href="index.cfm?action=workgroups.removeuser&workgroupkey=#urlencodedformat(url.entrykey)#&entrykey=#urlencodedformat(q_select_workgroup_members.userkey)##writeurltags()#"><span class="glyphicon glyphicon-trash"></span> #GetLangVal('cm_wd_delete')#</a>
	</td>
  </tr>
  </cfif>
  </cfoutput>
