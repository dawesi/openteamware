...
<cfif NOT StructKeyExists(request, 'a_bol_app_global_set')>
	...
	// ************ components ************
	request.a_str_component_accounting = '/components/accounting/cmp_accounting';
	request.a_str_component_shop = '/components/shop/cmp_shop';
	request.a_str_component_forum = "/components/forum/cmp_forum";
	...
	request.a_str_component_calendar = "/components/calendar/cmp_calendar";
	...
	request.a_str_component_storage = '/components/storage/cmp_storage';
	...
	request.a_str_component_fax = '/components/fax/cmp_fax';
	request.a_str_component_email_accounts = '/components/email/cmp_accounts';
	request.a_str_component_email_message = '/components/email/cmp_message';
	request.a_str_component_email = '/components/email/cmp_email';
	...
	request.a_str_component_billing = '/components/billing/cmp_billing';
	...
	request.a_str_component_mailspeed = '/components/email/cmp_mailspeed';
	...
	request.a_str_component_mobilesync = '/components/mobile/cmp_mobilesync';
	request.a_str_component_newsletter = '/components/newsletter/cmp_newsletter';
	request.a_str_component_communities = '/components/communities/cmp_communities';
	...
	request.a_str_component_mailconnector = '/components/email/cmp_mailconnector';
	...
	request.a_str_component_fckeditor = '/components/tools/cmp_fckeditor';
