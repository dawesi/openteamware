...
var popUpCal = {
	...
	nextText: '&gt&gt;', // Display text for next month link
	...
	monthNames: ['Jan','Feb','Mar','Apr','Mai','June','July','August','September','October','November','December'], // Names of months
	dateFormat: 'DMY.', // First three are day, month, year in the required order, fourth is the separator, e.g. US would be 'MDY/'
	yearRange: '-80:+150', // Range of years to display in drop-down, either relative to current year (-nn:+nn) or absolute (nnnn:nnnn)
