...
function SendTestMails(listkey,issuekey) {
	...
	a_simple_modal_dialog.customcontent_load_from_url = 'default.cfm?Action=SendTestMails&listkey=' + escape(listkey) + '&issuekey=' + escape(issuekey);
...
function CalcNumberOfSubscribers(listkey, id) {
	...
	a_simple_get.url = 'default.cfm?action=CalcNumberOfSubscribers&listkey=' + escape(listkey);
