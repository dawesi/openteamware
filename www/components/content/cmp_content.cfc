...
<cfcomponent output=false>
	...
	<cffunction access="public" name="DisplayUserSwitchDialog" output="false" returntype="string"
			hint="Display user switch dialog">
		<cfargument name="securitycontext" type="struct" required="true">
		
		<cfset var sReturn = '' />
		
		<cfsavecontent variable="sReturn">
			<cfinclude template="utils/inc_display_switch_user_dialog.cfm">
		</cfsavecontent>
	...
	<cffunction access="public" name="CreateDemoData" output="false" returntype="boolean" hint="create several demo entries">
		<cfargument name="userkey" type="string" required="yes">
		<cfargument name="companykey" type="string" required="yes">
		
		<cfinclude template="utils/inc_create_demo_data.cfm">
