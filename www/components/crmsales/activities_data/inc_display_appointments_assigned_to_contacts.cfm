	...
	<tr>
		...
		#a_str_td_break#
			...
			<cfif arguments.managemode>
				<br />
				<a href="/calendar/index.cfm?action=ShowEvent&entrykey=#q_select_events.entrykey#"><span class="glyphicon glyphicon-pencil"></span> #MakeFirstCharUCase(GetLangVal('cm_wd_edit'))#</a>
			</cfif>
		</td>
	</tr>
</cfoutput>
