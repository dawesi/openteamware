...
<table class="table_overview">
	...
	<tr>
		<td>
			<a href="/project/?action=ShowProject&entrykey=#q_select_sales_projects.entrykey#"><img src="/images/si/coins.png" class="si_img" /> #htmleditformat(CheckZeroString(q_select_sales_projects.title))#</a>
		</td>
		<td>
...
<cfif q_select_sales_projects.recordcount GT 0>
	<cfset a_str_info_cal = '<img src="/images/si/coins.png" class="si_img" /> #GetLangValJS('prj_ph_project_type_1')# (#q_select_sales_projects.recordcount#)' />
	
	<cfset tmp = AddJSToExecuteAfterPageLoad('AddCRMTopInfoString(''' & a_str_info_cal & ''')', '') />
</cfif>

<cfif q_select_common_projects.recordcount GT 0>
	<cfset a_str_info_cal = '<img src="/images/si/chart_organisation.png" class="si_img" /> #GetLangValJS('prj_ph_project_type_0')# (#q_select_common_projects.recordcount#)' />
