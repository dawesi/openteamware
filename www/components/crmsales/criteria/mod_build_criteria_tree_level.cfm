	...
	<cfif a_bol_display>
		...
		<cfelse>
			...
			<cfif ListFindNoCase(attributes.options, 'allow_add_admin_tool') GT 0>
				...
				&nbsp;
				<a onClick="return confirm('#GetLangValJS('cm_ph_are_you_sure')#');" href="index.cfm?action=criteria&subaction=DeleteCriteria#attributes.url_tags_to_add#&id=#q_select_current_level.id#"><span class="glyphicon glyphicon-trash"></span></a>
			</cfif>
