...
<!--- //
	...
	<cffunction access="public" name="DebitPointsAccount" returntype="boolean" output="false">
		<cfargument name="securitycontext" type="struct" required="yes">
	...
	<cffunction access="public" name="GetPromocodes" returntype="query" output="false">
		<cfargument name="filter" type="struct" required="no" default="#StructNew()#">
		
	</cffunction>
	
	<cffunction access="public" name="CheckPromocode" returntype="boolean" output="false">
		<cfargument name="code" type="numeric" required="yes">
		
		<cfreturn true>
	</cffunction>
	
	<cffunction access="public" name="UpdatePromocodeUsed" returntype="boolean" output="false">
		<cfargument name="companykey" type="string" required="yes">
