...
<cfquery name="q_select_points_entry" datasource="#request.a_str_db_users#">
SELECT
...
<!--- update --->
<cfquery name="q_update_points_entry" datasource="#request.a_str_db_users#">
UPDATE
	consumergoods
SET
...
<!--- insert --->
<cfquery name="q_insert_points_entry" datasource="#request.a_str_db_users#">
INSERT INTO
	consumergoods
	(
	companykey,
