...
<cfloop from="1" to="#a_int_jj#" index="ii">
	...
	<!---<cfmail from="#request.appsettings.properties.NotifyEmail#" to="#request.appsettings.properties.NotifyEmail#" subject="a_struct_item" type="html"><cfdump var="#a_struct_item#"></cfmail>--->
	
	<cfset a_dt_lastmod = a_struct_item.A_DT_LASTMOD>
...
A_STR_OUTLOOK_ID 00000000C09EF73BAB6E854EAB77BC856DA0CCD9A4B62300 
	...
	<cfif MetaItemExists(arguments.servicekey, arguments.program_id, a_struct_item.a_str_inboxcc_entrykey)>
		...
		WHERE
			...
			(eventkey = <cfqueryparam cfsqltype="cf_sql_varchar" value="#a_struct_item.a_str_inboxcc_entrykey#">)
			AND
