...
>
	...
	<cfparam name="this.basePath" type="string" default="/common/js/fckeditor_current/" />
...
>
	...
	<cfoutput>
	<div>
	<textarea name="#this.instanceName#" rows="4" cols="40" style="WIDTH: #this.width#; HEIGHT: #this.height#" wrap="virtual">#HTMLEditFormat(this.value)#</textarea>
	</div>
	</cfoutput>
