...
<cfcomponent output="false">
	...
	<cffunction access="public" name="CreatePDFofHTMLContent" output="false" returntype="string"
		...
		<cfset var a_str_tmp_file = request.a_str_temp_directory & request.a_str_dir_separator & CreateUUID()& '.html' />
		<cfset var a_str_dest_file = request.a_str_temp_directory & request.a_str_dir_separator & CreateUUID() & '.pdf' />
		<cfset var a_str_sh_filename = request.a_str_temp_directory & request.a_str_dir_separator & CreateUUID() & '.sh' />
