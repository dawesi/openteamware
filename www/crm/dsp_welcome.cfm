...
<cfsavecontent variable="a_str_btn">
	<a style="font-weight:normal" href="<cfoutput>#cgi.SCRIPT_NAME#?#cgi.QUERY_STRING#</cfoutput>&amp;format=pdf&amp;extractcontentid=followuplist"><span class="glyphicon glyphicon-circle-arrow-down"></span> Export as PDF</a>
</cfsavecontent>
