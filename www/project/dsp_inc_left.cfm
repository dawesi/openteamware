...
<div class="divleftnavigation_center">
	...
	<div class="divleftnavpanelactions">	
		...
		<ul class="divleftpanelactions">
			<li><a href="default.cfm?action=NewProject&type=0"><cfoutput>#GetLangVal('crm_ph_project_type_0')#</cfoutput></a></li>
			<li><a href="default.cfm?action=NewProject&type=1"><cfoutput>#GetLangVal('crm_ph_project_type_1')#</cfoutput></a></li>
		</ul>
