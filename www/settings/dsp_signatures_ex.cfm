...
<cf_disp_navigation mytextleft="#GetLangVal('mail_ph_email_signatures')#">
<br>
...
<cfif Len(url.subaction) IS 0>
	<fieldset class="bg_fieldset" style="width:500px; ">
		<legend><cfoutput>#GetLangVal('prf_ph_create_new_sig')#</cfoutput></legend>
	...
	<fieldset class="bg_fieldset" style="width:500px; ">
		...
		<div style="padding:8px; ">
			...
			<cfif q_select_signatures.default_sig IS 0>
				<p>
					<a href="act_set_default_sig.cfm?entrykey=#q_select_signatures.entrykey#&format=#q_select_signatures.sig_type#"><img vspace="4" hspace="4" src="/images/icon/icon_star.gif" align="absmiddle" border="0"> Diese Signatur als Standard-Signatur setzen (<cfif q_select_signatures.sig_type IS 0>Text<cfelse>HTML</cfif>)</a>
				</p>
			<cfelse>
				<p><img src="/images/icon/icon_star.gif" align="absmiddle" border="0" vspace="4" hspace="4"> Dies ist die standardmaessige Signatur (<cfif q_select_signatures.sig_type IS 0>Text<cfelse>HTML</cfif>)</p>
			</cfif>			
