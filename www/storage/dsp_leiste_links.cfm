...
<div class="divleftnavigation_center">
	...
	<cfcase value="ShowFiles,ShowWelcome">		
			...
			<li><a target="_blank" onclick="window.open('/storage/default.cfm?action=AddFile&parentdirectorykey=#url.directorykey#','_blank','toolbar=no,location=no,directories=no,status=no,copyhistory=no,scrollbars=yes,resizable=yes,height=400,width=600');return false;" href="##"><b>#getlangval('sto_ph_addfiles')#</b></a></li>
			<li><a href="default.cfm?action=createNewFile&entrykey=#url.directorykey#&currentdir=#url.directorykey#">#GetLangVal('sto_ph_create_new_file')#</a></li>
			<li><a href="/storage/default.cfm?action=NewFolder&parentdirectorykey=<cfoutput>#url.directorykey#</cfoutput>&currentdir=<cfoutput>#url.directorykey#</cfoutput>"><cfoutput>#getlangval('sto_ph_createdirectory')#</cfoutput></a></li>
			<li><a href="default.cfm?action=EditFolder&entrykey=#url.directorykey#&currentdir=#url.directorykey#">#MakeFirstCharUCase(GetLangVal('cm_wd_edit'))#</a></li>
			<li><a href="default.cfm?action=EditFolder&entrykey=#url.directorykey#&currentdir=#url.directorykey#">#GetLangVal('sto_wd_share')#</a></li>
		...
		<div class="divleftnavpanelheader"><cfoutput>#GetLangVal('cm_wd_global')#</cfoutput></div>
			...
			<!---<li><a href="default.cfm?action=showfiles"><cfoutput>#GetLangVal("sto_ph_showfiles")#</cfoutput></a></li>--->
			<li>
				<div>
				<cfoutput>
			...
			<li><a href="default.cfm?action=shares"><cfoutput>#GetLangVal('sto_ph_sharedfiles')#</cfoutput></a></li>
			...
			<li><a href="default.cfm?action=usageinfo"><cfoutput>#GetLangVal('sto_wd_usage')#</cfoutput></a></li>
