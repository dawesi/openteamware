		...
		<cfif a_current_hint.counter lte 0>
			...
			<div style="padding-left:#a_int_padding_left#px;padding-top:3px; ">
				...
				<cfloop query="q_select_files">
					<input type="checkbox" name="frmFilesentrykeys" value="#q_select_files.entrykey#" class="noborder"> <a target="_blank" href="../storage/index.cfm?action=ShowFile&entrykey=#q_select_files.entrykey#">#htmleditformat(q_select_files.name)#</a> (#ByteConvert(q_select_files.filesize)#)<br>
				</cfloop>
