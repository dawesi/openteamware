...
<div class="divleftnavigation_center">
	...
	<cfcase value="ShowTask,Edittask">	
		<div class="divleftnavpanelheader"><!---&raquo; ---><cfoutput>#GetLangVal('cm_wd_task')#</cfoutput></div>
			...
			<li><a href="index.cfm?action=edittask&entrykey=<cfoutput>#url.entrykey#</cfoutput>"><cfoutput>#GetLangVal('cm_wd_Edit')#</cfoutput></a></li>
			<li><a href="index.cfm?action=deletetask&entrykey=<cfoutput>#url.entrykey#</cfoutput>"><cfoutput>#GetLangVal('cm_wd_delete')#</cfoutput></a></li>
			<li><a target="_blank" href="index.cfm?action=PrintVersion&entrykeys=<cfoutput>#url.entrykey#</cfoutput>"><cfoutput>#GetLangVal('cal_wd_printversion')#</cfoutput></a></li>
			<!---<li>Weiterleiten</li>--->
			</ul>
		...
		<div class="divleftnavpanelheader"><!---&raquo; ---><cfoutput>#GetLangVal('cm_wd_global')#</cfoutput></div>
			...
			<ul class="divleftpanelactions">
			<li><a href="index.cfm?action=newtask">Neue Aufgabe</a></li>
			<li><a href="index.cfm"><cfoutput>#htmleditformat(GetLangval('cm_wd_overview'))#</cfoutput></a></li>
			<li><a href="index.cfm?filterstatus=open&filtercategory=&filterworkgroup=&filtertimeframe=&filterpriority=">Reset filter</a></li>
			<li><a href="/assistants/import/"><cfoutput>#GetLangVal('adrb_ph_outlook_sync')#</cfoutput></a></li>
			<li><a style="color:#CC0000; " href="index.cfm?filtertimeframe=overdue"><cfoutput>#GetLangVal('tsk_wd_view_overdue')#</cfoutput></a></li>
