...
<tr>
	...
	<td><a href="default.cfm?action=NewTask">Erweiterte Eingabe ...</a></td>
</tr>
</form>
</table>
</div>
...
<table border="0" cellspacing="2" cellpadding="4" align="center">
  <tr>
	...
	<a class="simplelink" href="default.cfm?<cfoutput>#ReplaceOrAddURLParameter(cgi.QUERY_STRING, "status", 1)#</cfoutput>"><img src="/images/high.png" width="8" height="17" hspace="2" vspace="2" align="absmiddle" border="0"><cfoutput>#GetLangVal("tsk_wd_view_due")#</cfoutput> (7)</a>
	</td>
    <td width="120px" align="center" class="bl">
	<a class="simplelink" href="default.cfm?<cfoutput>#ReplaceOrAddURLParameter(cgi.QUERY_STRING, "status", 2)#</cfoutput>"><img src="/images/high.png" width="8" height="17" hspace="2" vspace="2" align="absmiddle" border="0"><img src="/images/high.png" width="8" height="17" hspace="2" vspace="2" align="absmiddle" border="0"><cfoutput>#GetLangVal("tsk_wd_view_overdue")#</cfoutput> (18)</a>
	</td>
    <td width="120px" align="center" class="bl">
	<a class="simplelink" href="default.cfm?<cfoutput>#ReplaceOrAddURLParameter(cgi.QUERY_STRING, "status", 0)#</cfoutput>"><img src="/images/set_status_done.gif" height="16" width="16" border="0" vspace="2" hspace="2" align="absmiddle"><cfoutput>#GetLangVal("tsk_wd_view_done")#</cfoutput> (127)</a>
	</td>
  </tr>
</table>
</div>
