...
<cfset a_cmp_forms = application.components.cmp_forms>
...
<cfset a_struct_force_options_replace.userkey = a_cmp_forms.AddItemToArrayOfOptions(a_struct_force_options_replace.userkey, a_cmp_users.GetFullNameByentrykey(request.stSecurityContext.myuserkey), request.stSecurityContext.myuserkey)>

<cfoutput query="q_select_assignments">
	<cfset a_struct_force_options_replace.userkey = a_cmp_forms.AddItemToArrayOfOptions(a_struct_force_options_replace.userkey, application.components.cmp_user.GetUsernamebyentrykey(q_select_assignments.userkey), q_select_assignments.userkey)>
</cfoutput>
...
<cfoutput query="q_select_shares">
	...
	<cfloop query="q_select_workgroup_members">
		...
		<cfif ListFind(a_str_displayed_userkeys, q_select_workgroup_members.userkey) IS 0>
			...
			<cfset a_struct_force_options_replace.userkey = a_cmp_forms.AddItemToArrayOfOptions(a_struct_force_options_replace.userkey, application.components.cmp_user.GetUsernamebyentrykey(q_select_workgroup_members.userkey), q_select_workgroup_members.userkey)>
		</cfif>
	</cfloop>

</cfoutput>		
	
<cfset a_str_form = a_cmp_forms.DisplaySavedForm(force_element_values = a_struct_force_element_values,
